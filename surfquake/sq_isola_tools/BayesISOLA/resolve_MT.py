...
class resolve_MT:
	...
	from surfquake.sq_isola_tools.BayesISOLA._inverse import run_inversion, find_best_grid_point
	from surfquake.sq_isola_tools.BayesISOLA._VR import VR_of_components
	from surfquake.sq_isola_tools.BayesISOLA._print import print_solution, print_fault_planes
	from surfquake.sq_isola_tools.BayesISOLA._save import save_seismo
