...
class plot:
	...
	from surfquake.sq_isola_tools.BayesISOLA._plot import plot_stations, plot_covariance_matrix
	from surfquake.sq_isola_tools.BayesISOLA._plot_solution_summary import plot_MT, plot_uncertainty, plot_MT_uncertainty_centroid
	from surfquake.sq_isola_tools.BayesISOLA._plot_solution_maps import plot_maps, plot_slices, plot_maps_sum, plot_map_backend, plot_3D
	from surfquake.sq_isola_tools.BayesISOLA._plot_data import plot_seismo, plot_covariance_function, plot_noise, plot_spectra, plot_seismo_backend_1, plot_seismo_backend_2
	from surfquake.sq_isola_tools.BayesISOLA._html import html_log
