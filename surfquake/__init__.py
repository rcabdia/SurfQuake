...
station = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/data", "station", "station.dat")
ttime = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/data", "tt_real", "ttdb.txt")
mseed_dir = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/data", "mseed")
model_dir = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/loc_flow_tools", "models", "190703-214543")
realout = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/loc_flow_tools", "out_data", "phase_sel_total.txt")
nllinput = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/loc_flow_tools", "location_output/obs", "nll_input.txt")
...
TT_DB_PATH = os.path.join(os.path.dirname(ROOT_DIR), "surfquake/loc_flow_tools/tt_db", "mymodel.nd")
