...
def pred_fn(data_reader, figure_dir=None, prob_dir=None, log_dir=None):
    ...
    dataset = data_reader.dataset(20)
    ...
    with tf.compat.v1.Session(config=sess_config) as sess:
        ...
        latest_check_point = tf.train.latest_checkpoint('/home/sysop/Escritorio/phasenet example/model/190703-214543')
...
"""
        ...
        for _ in tqdm(range(0, data_reader.num_data, 20), desc="Pred"):
            """if args.amplitude:
...
def main():
    ...
    with tf.compat.v1.name_scope("create_inputs"):
        ...
        data_reader = DataReader_pred(
            format='mseed',
            data_dir='/home/sysop/Escritorio/phasenet example/demo/mseed',
            data_list='/home/sysop/Escritorio/phasenet example/demo/fname.csv',
            hdf5_file=None,
            hdf5_group=None,
            amplitude=None,
            highpass_filter=0
        ...
        pred_fn(data_reader, log_dir='/home/sysop/Escritorio/phasenet example/demo/mseed')
