...
class resolve_MT:
	...
	from loc_flow_isp.sq_isola_tools.BayesISOLA._inverse import run_inversion, find_best_grid_point
	from loc_flow_isp.sq_isola_tools.BayesISOLA._VR import VR_of_components
