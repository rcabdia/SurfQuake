...
class process_data:
	...
	from loc_flow_isp.sq_isola_tools.BayesISOLA._green import set_Greens_parameters, write_Greens_parameters, verify_Greens_parameters, verify_Greens_headers, calculate_or_verify_Green, calculate_Green, use_elemse_from_files, use_elemse_from_syngine
	from loc_flow_isp.sq_isola_tools.BayesISOLA._parameters import set_frequencies, set_working_sampling, count_components, min_time, max_time, set_time_window, set_parameters, skip_short_records
	from loc_flow_isp.sq_isola_tools.BayesISOLA._process_data import correct_data, trim_filter_data, decimate_shift
